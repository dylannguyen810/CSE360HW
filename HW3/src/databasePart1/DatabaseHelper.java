...
public class DatabaseHelper {
	...
	private void createTables() throws SQLException {
	    ...
	    String invitationCodesTable = "CREATE TABLE IF NOT EXISTS InvitationCodes ("
	            ...
	            + "role VARCHAR(20), "  // Add role column
	...
	public void register(User user, String invitationCode) throws SQLException {
		String role = getRoleFromInvitationCode(invitationCode); // Get role from invitation code
		...
		try (PreparedStatement pstmt = connection.prepareStatement(insertUser)) {
			...
			if (role == null) {
				role = user.getRole(); // If role is null, use user's role
			}
