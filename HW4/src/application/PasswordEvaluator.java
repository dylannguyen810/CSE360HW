...
public class PasswordEvaluator {
	...
	public static boolean foundSpace = false;
	...
	public static String evaluatePassword(String input) {
		...
		foundSpace = false;					// Reset the Boolean flag
		...
		while (running) {
			...
			// Go to the next character if there is one or stop running if otherChar has been found
			currentCharNdx++;
